    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('EMPLOYEE', 'EMPLOYE'), ('RESPONSIBLE', 'RESPONSABLE'), ('RH', 'RH'), ('ADMIN', 'ADMIN')], default='EMPLOYEE', max_length=15, verbose_name='Role')),
                ('first_name', models.CharField(max_length=150, verbose_name='Nom de famille')),
                ('last_name', models.CharField(max_length=150, verbose_name='Prenom.s')),
